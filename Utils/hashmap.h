...
#define defineMap(_key_type, _value_type)                                                                               \
    ...
    typedef struct _Map_##_key_type##_value_type {                                                                      \
        ...
        bool (*contains)(struct _Map_##_key_type##_value_type *map, _key_type key);                                     \
                                                                                                                        \
    ...
    {                                                                                                                   \
        return map->_entities==0;                                                                                       \
                                                                                                                        ...
                                                                                                                        \
    bool _map_##_key_type##_value_type##_contains(Map_##_key_type##_value_type *map, _key_type key)                     \
    {                                                                                                                   \
        return map->find(map, key) != NULL;                                                                             \
    }                                                                                                                   \
                                                                                                                        \
    ...
    {                                                                                                                   \
        ...
        _map.contains = _map_##_key_type##_value_type##_contains;                                                       \
                                                                                                                        \
        return _map;                                                                                                    \
    }                                                                                                                   \
...
#define map_contains(_map, _key)                                                                                        \
    _map.contains(&_map, _key)                                                                                          \
